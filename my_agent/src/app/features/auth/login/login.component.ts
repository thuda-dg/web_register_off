      ...
      <div class="mx-auto flex max-w-md flex-col rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        <div class="mb-6 text-center">
          ...
          <p class="mt-2 text-sm text-slate-500">
            Đăng nhập để sử dụng hệ thống lịch nghỉ
          </p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            [disabled]="loading()"
            class="w-full rounded-lg bg-emerald-700 px-4 py-2 font-semibold text-white disabled:cursor-not-allowed disabled:opacity-60"
          >
            {{ loading()
              ? 'Đang đăng nhập...'
              : 'Đăng nhập'
        ...
        <div class="mt-6 text-center text-sm text-slate-500">
          ...
          <a
            routerLink="/register"
            class="ml-1 font-semibold text-emerald-700"
          >
            Đăng ký ngay
          </a>
        </div>
